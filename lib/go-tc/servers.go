...
func (sus ServerUpdateStatus) MarshalJSON() ([]byte, error) {
	formatTime := struct {
		...
		ConfigUpdateTime:     sus.ConfigUpdateTime.Format(time.RFC3339),
		ConfigApplyTime:      sus.ConfigApplyTime.Format(time.RFC3339),
		RevalidateUpdateTime: sus.RevalidateUpdateTime.Format(time.RFC3339),
		RevalidateApplyTime:  sus.RevalidateApplyTime.Format(time.RFC3339),
	}
